-- Migration: Ensure RPC function has proper security settings
-- The mark_invoice_paid_and_confirm_booking function must run as SECURITY DEFINER
-- to bypass RLS when creating confirmed bookings

-- Recreate the function with SECURITY DEFINER
-- This allows the function to create bookings even when RLS is enabled

      ...
      <div className="flex-1 flex overflow-hidden relative">
         ...
         <div className="w-[648px] flex-shrink-0 border-r border-gray-800 bg-[#161B22] z-20 flex flex-col">
            ...
            <div className="overflow-y-auto flex-1 scrollbar-hide">
                ...
                <div className="grid grid-cols-[minmax(0,0.55fr)_minmax(0,0.37fr)_minmax(0,1.4fr)_minmax(0,0.65fr)_auto_auto_auto] gap-0.5 w-full min-w-0 px-2 py-1.5 border-b border-gray-700 bg-[#1C1F24]/80">
                ...
                {filteredRooms.map(room => {
                    ...
                    >
                        <div className="grid grid-cols-[minmax(0,0.55fr)_minmax(0,0.37fr)_minmax(0,1.4fr)_minmax(0,0.65fr)_auto_auto_auto] gap-0.5 w-full min-w-0 overflow-hidden items-center whitespace-nowrap justify-items-start">
